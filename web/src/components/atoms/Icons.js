  ...
  >
    <g className="heart">
      ...
      <rect
        ...
        x='27.364'
        y='61.657'
        fill='var(--primary-200, #7DD3C8)'
        rx='13.232'
        transform='rotate(-120 27.364 61.657)'
      ></rect>
      <path
        fill='var(--primary-300, #3FA99D)'
    ...
    <text
      x="68"
      y="24"
      fill={variant === 'light' ? '#fff' : 'var(--primary-400, #0E7E73)'}
    ...
    <text
      x="68"
      y="48"
      fill={variant === 'light' ? '#fff' : 'var(--dark-500, #0D1F26)'}
...
export const ListBullet = () => (
  <svg
    ...
    viewBox='0 0 30 30'
  >
    <circle cx='14.664' cy='15.37' r='14.5' fill='#0E7E73'></circle>
    <path
      stroke='#fff'
      strokeLinecap='round'
